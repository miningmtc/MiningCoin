...
/**
 * @dev The official MiningCoin smart contract
 */
contract MiningCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "Mining";
    string private _symbol   = "MTC";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for mining/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xb07072eDD2B46727F293233677A04af857e7E0cE); // Marketing address used to pay for marketing
    ...
    uint256 public _buybackUpperLimit    = 1 * 10**9 * 10**9; // 1 billion $Mining will be used to buy at maximum in any one trade
    ...
    /**
     * @notice Withdraws non-Mining tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts Mining balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns Mining tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of Mining tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from Mining)
